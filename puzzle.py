...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def saving(self, name):
        ...
        textureType = Tileset.slot in range(1, 4)
        ...
        anime = ['belt_conveyor_anime', 'block_anime', 'block_anime_L', 'hatena_anime', 'hatena_anime_L', 'tuka_coin_anime']
